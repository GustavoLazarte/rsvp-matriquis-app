...
export const T: Record<Lang, Record<string, any>> = {
  es: {
    ...
    tl_events: [
      { time: '15:30', name: 'Recepción', desc: 'Copa de bienvenida en los jardines.', gold: false, emoji: '🌿' },
      { time: '16:30', name: 'Ceremonia', desc: 'El sí definitivo.', gold: false, emoji: '💍' },
      { time: '17:00', name: 'Baile Principal', desc: 'DJ en vivo — la pista es tuya.', gold: true, emoji: '💃' },
      { time: '18:00', name: 'Cena', desc: 'Menú de temporada en buena mesa.', gold: false, emoji: '🍽️' },
      { time: '21:00', name: 'Torta & Mesa Dulce', desc: 'El momento más dulce de la noche.', gold: false, emoji: '🎂' },
      { time: '23:30', name: 'Fin de la Fiesta', desc: 'Hasta la próxima.', gold: false, emoji: '✨' },
    ],
  ...
  en: {
    ...
    tl_events: [
      { time: '3:30 PM', name: 'Reception', desc: 'Welcome drinks in the gardens.', gold: false, emoji: '🌿' },
      { time: '4:30 PM', name: 'Ceremony', desc: 'The definitive "I do".', gold: false, emoji: '💍' },
      { time: '5:00 PM', name: 'Main Dance', desc: 'Live DJ — the dance floor is yours.', gold: true, emoji: '💃' },
      { time: '6:00 PM', name: 'Dinner', desc: 'Seasonal menu at a great table.', gold: false, emoji: '🍽️' },
      { time: '9:00 PM', name: 'Cake & Sweet Table', desc: 'The sweetest moment of the night.', gold: false, emoji: '🎂' },
      { time: '11:30 PM', name: 'End of the Party', desc: 'Until next time.', gold: false, emoji: '✨' },
    ],
